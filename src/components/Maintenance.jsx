...
import { FaCog } from 'react-icons/fa'; // spinning gear icon
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-blue-50 to-white p-6 mt-10 text-center">
      <div className="max-w-3xl bg-white rounded-xl shadow-lg p-8 mx-auto">
        <h1 className="text-3xl font-bold text-blue-800 mb-2">We're working on it</h1>
        ...
        <div className="flex flex-col items-center space-y-6">
          ...
          {/* Spinning icon */}
          <FaCog className="text-blue-500 text-3xl animate-spin" />

          <p className="text-gray-600 mb-6">
            We're currently updating this page with the latest technology and insights.
